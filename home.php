        ...
        <div class="home_title_sub">ニュース</div>
          ...
          <div class="news_post_small">
            <div class="news_post_meta">
              <ul>
                <li>           
                  <a href="<?php echo get_permalink(); ?>"><!-- aタグで投稿記事へのリンクを作成 -->             
                    <?php echo get_the_date(); ?> <!-- 日付を出力する -->
                  </a>
                </li>
              </ul>
            </div>
            <div class="news_post_small_title">
              <a href="<?php the_permalink(); ?>">   <!--  aタグで投稿記事へのリンクを作成する -->    
...
<!-- 卒業生の声 -->
<div class="col-lg-6 col-md-6 col-sx-12 news_col">
  <div class="home_title">GRDUATES</div>
